    ...
    stages {
        ...
        stage('Docker run') {
            ...
            steps {
                ...
                sh 'docker run -d --network=blooming_network -e VIRTUAL_HOST=www.inhousesoft.co.kr,www.inhousesoft.com -p 5020:5020 --name inhousesoft inhouse-web-image:latest'
            }
        }
    }
}
